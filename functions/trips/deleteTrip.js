...
exports.handler = async (event) => {
  ...
  const { trip, members, logistics, bookings, plans, suggestions, approvals } = await getTripAggregate(tripId)
  ...
  const allItems = [trip, ...members, ...logistics, ...bookings, ...plans, ...suggestions, ...approvals]
