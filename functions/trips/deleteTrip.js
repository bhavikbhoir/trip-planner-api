...
exports.handler = async (event) => {
  ...
  const { trip, members, logistics, bookings, plans, suggestions, approvals, eventCompletions, expenses, tips } = await getTripAggregate(tripId)
  ...
  const allItems = [trip, ...members, ...logistics, ...bookings, ...plans, ...suggestions, ...approvals, ...eventCompletions, ...expenses, ...tips]
